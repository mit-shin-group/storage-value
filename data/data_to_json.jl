...
data = Dict(
    ...
    "value of lost load (\$/MWh)" => 2500.,
    "battery lifetime (years)" => 20,
    "battery min. investment (MW)" => 3,
    "battery max. investment (MW)" => 40.,
    ...
    "backup min. investment (MW)" => 10.,
    "backup max. investment (MW)" => 20.,
    "backup electricity price (\$/MWh)" => 1000 * price_per_l / diesel_LHV * turbine_heat_rate .* ones(26,24),
